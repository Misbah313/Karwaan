...
--
-- Class BoardAnalytics as table board_analytics
--
...
--
-- Class BoardCard as table board_card
--
...
--
-- Class BoardCardAssignment as table board_card_assignment
--
...
--
-- Class BoardDetails as table board_details
--
...
--
-- Class OverAllAnalytics as table over_all_analytics
--
...
--
-- Class PinnedBoard as table pinned_boards
--
...
--
-- Class UserRecentBoards as table user_recent_boards
--
...
--
-- Foreign relations for "board_analytics" table
--
...
--
-- Foreign relations for "board_card" table
--
ALTER TABLE ONLY "board_card"
    ADD CONSTRAINT "board_card_fk_0"
    FOREIGN KEY("createdBy")
    REFERENCES "user"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "board_card"
    ADD CONSTRAINT "board_card_fk_1"
    FOREIGN KEY("list")
...
--
-- Foreign relations for "board_card_assignment" table
--
...
--
-- Foreign relations for "board_details" table
--
ALTER TABLE ONLY "board_details"
    ADD CONSTRAINT "board_details_fk_0"
    FOREIGN KEY("workspaceId")
    REFERENCES "workspace"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "over_all_analytics" table
--
...
--
-- Foreign relations for "user_recent_boards" table
--
